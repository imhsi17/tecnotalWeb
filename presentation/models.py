...
class Service(models.Model):
    ...
    description = models.CharField('Descripción', max_length=200, default='Descripción del servicio')
...
class Company(models.Model):
    ...
    main_service = models.CharField('Servicio principal', blank=False, null=False, default='Servicio que ofrece la empresa')
...
class Project(models.Model):
    ...
    weight = models.DecimalField('Peso', max_digits=6, decimal_places=2, blank=False, null=False)
